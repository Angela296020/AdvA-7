...
public class WebdriverUtil {
   ...
   /**
    * this below method is used to refresh the page
    * @param driver
    */
   ...
   /**
    * this below method is used for explicit wait
    * @param driver
    * @param element
    */
	...
	/**
	 * this below method is used to switch the frame using webelement
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * this below method is used to switch back driver control to main page
	 * @param driver
	 */
	...
	/**
	 * this below method is used to select the dropdown using value
	 * @param dropdown
	 * @param value
	 */
	...
	/**
	 * this below method is used to select the dropdown using visible text
	 * @param dropdown
	 * @param value
	 */
	...
	/**
	 * this below method is used to deselect the dropdown using visible text
	 * @param dropdown
	 * @param visibleText
	 */
	...
	/**
	 * this below method is used to handle your alert popuop
	 * @param driver
	 */
	...
	/**
	 * this below method is used to click on cancel button present on popup
	 * @param driver
	 */
